    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-primary-50 flex items-center justify-center p-4 py-12">
      <div className="w-full max-w-md">
        ...
        <Link to="/" className="flex items-center justify-center gap-2 mb-8">
          ...
          <span className="text-2xl font-bold text-gray-900">ChannelX</span>
        </Link>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="bg-gray-50 rounded-xl p-4">
              ...
              <ul className="space-y-1 text-sm">
                ...
                <li className={`flex items-center gap-2 transition-colors ${
                  passwordValidation.hasNumberOrSpecial ? 'text-green-600' : 'text-gray-600'
                }`}>
                  <CheckCircle className={`w-4 h-4 ${
                    passwordValidation.hasNumberOrSpecial ? 'text-green-500' : 'text-gray-400'
                  }`} />
